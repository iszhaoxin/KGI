    ...
    void bfgs()
    {
        ...
        int batchsize = fb_h.size()/nbatches;
            for (int epoch=0; epoch<nepoch; epoch++)
            {
                ...
                FILE* f2 = fopen(("../../data/Overlap20.0_TrainRate40.0/subG2/relation2vec."+version).c_str(),"w");
                FILE* f3 = fopen(("../../data/Overlap20.0_TrainRate40.0/subG2/entity2vec."+version).c_str(),"w");
                for (int i=0; i<relation_num; i++)
                {
                    for (int ii=0; ii<n; ii++)
...
void prepare()
{
    FILE* f1 = fopen("../../data/Overlap20.0_TrainRate40.0/subG2/entity2id.txt","r");
	FILE* f2 = fopen("../../data/Overlap20.0_TrainRate40.0/subG2/relation2id.txt","r");
	int x;
    ...
    FILE* f_kb = fopen("../../data/Overlap20.0_TrainRate40.0/subG2/train.txt","r");
