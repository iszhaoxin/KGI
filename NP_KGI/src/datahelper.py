...
if __name__ == "__main__":
    def w(root):
        subG1 = root+"/subG1/train.txt"
        subG2 = root+"/subG2/train.txt"
        subG1_helper = DataHelper(subG1)
        subG2_helper = DataHelper(subG2)
        subG1_helper.write2flie()
        subG2_helper.write2flie()
    # cohesive = "/home/dreamer/codes/my_code/KGI/sampling/results/fb15k/OverRate50_TrainRate70/cohesive_subGraph1"
    unifrom = "/home/dreamer/codes/my_code/KGI/sampling/results/fb15k/50_70_4/uniform"
    # w(cohesive)
    w(unifrom)
